    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo site_url('c_lap_jual') ?>">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Laporan Pemasukan</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo site_url('c_lap_beli') ?>">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Laporan Pengeluaran</span>
              </a>
            </li>
            <div class="container mt-4">
              <a href="<?php echo base_url('index.php/backup'); ?>" class="btn btn-success">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center ml-auto ml-md-0">
            <li class="nav-item dropdown">
              ...
              <!-- INI HARUS DI LUAR <a> TAPI DI DALAM <li> -->
