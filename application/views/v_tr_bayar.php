                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr />
                            <?php
                                echo form_open_multipart('DashboardPelanggan/cust_tr_bayar/'.$transaksi->tj_id);
                            ?>
                                <div class="mb-3">
                                ...
                                <a href="<?= base_url('DashboardPelanggan/daftar_transaksi') ?>" class="btn btn-light">Kembali</a>
                            <?php
                                echo form_close('')
                            ?>
                        </div> <!-- end card-body-->
