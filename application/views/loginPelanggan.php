        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form action="<?php echo site_url('LoginPelanggan/validation') ?>" method="post" autocomplete="off">
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="<?php echo site_url('Home/registrasi') ?>" class="text-light"><small>Create new account</small></a>
            </div>
          </div>
        </div>
      </div>
