    ...
    <div class="col-lg-12 col-md-7">
        <div class="card">
            <div class="card-block">
                <form supplier="form" action="<?php echo site_url('supplier/supplierController/tambah') ?>" method="post">
                    <div class="box-body">
                        <input hidden="true" class="form-control" type="text" name="creaby" value="<?php echo $this->session->userdata('id_kary'); ?>">
                        <div class="col-lg-5 mb-3">
                            <label for="nama_supplier">Nama<span style="color:red"> * </span></label>
                            <input type="text" class="form-control" id="nama_supp" name="nama_supp" required>
                        </div>
                        <div class="col-lg-5 mb-3">
